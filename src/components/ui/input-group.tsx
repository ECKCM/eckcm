...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group border-input bg-background relative flex w-full items-center rounded-md border ring-offset-background transition-[color,box-shadow] outline-none",
        "h-10 min-w-0",
